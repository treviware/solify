...
const lamportsAmount = computed(() => walletData.value.amount);
...
<template>
  <q-expansion-item expand-icon-toggle expand-separator expand-icon="fa-solid fa-caret-down">
    <template v-slot:header>
      ...
      <q-item-section side>
        <div>
          <q-badge v-if="isConnected" color="secondary" text-color="dark" class="text-bold q-mr-sm" label="Connected" />
          ...
          <q-btn color="negative" flat dense @click="remove" round class="rounded-borders" :disable="isConnected">
          ...
          <q-item>
            ...
            <q-item-section>
              <q-item-label class="row justify-between">
                <div>Solana</div>
                <div class="text-caption cursor-pointer" @click="showBps = !showBps">
                  <template v-if="showBps">{{ lamportsAmount }} LAMPORTS</template>
                  <template v-else>{{ solAmount }} SOL</template>
                </div>
              </q-item-label>
            </q-item-section>
          </q-item>
